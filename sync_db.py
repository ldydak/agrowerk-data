...
def download_from_prod():
    ...
    replace_links_in_file(DUMP_FILE, 'https://data.agrowerk.pl', 'http://agrowerk-data.xyz')
...
def send_to_prod():
    ...
    replace_links_in_file(DUMP_FILE, 'http://agrowerk-data.xyz', 'https://data.agrowerk.pl')
